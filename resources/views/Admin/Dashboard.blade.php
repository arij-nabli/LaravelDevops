                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-4 d-flex">
                            <div class="card wizard-card flex-fill">
                                <div class="card-body">
                                    <p class="text-primary mt-0 mb-2">Recycling centers</p>
                                    <h5>1000</h5>
                        ...
                        <div class="col-md-4 d-flex">
                            <div class="card wizard-card flex-fill">
                                <div class="card-body">
                                    <p class="text-primary mt-0 mb-2">Waste collections</p>
                                    <h5>1568</h5>
                                    <p><a href="projects.html">view details</a></p>
                                    <span class="dash-widget-icon bg-1">
                ...
                <div class="col-md-4 d-flex">
                    <div class="card w-100">
                        <div class="card-body pt-0">
                            ...
                            <div class="mt-3">
    <h6 class="text-primary">Waste Collection</h6>
    <div class="table-responsive">
        <table class="table table-center table-hover mb-0">
            <thead>
                <tr>
                    <th class="text-nowrap">Recycling Center Name</th>
            ...
            <tbody>
                <tr>
                    <td class="text-nowrap">Tunis Recycling Center</td>
                    <td>15/10/2024</td>
                    <td class="text-end">Completed</td>
                </tr>
                <tr>
                    <td class="text-nowrap">Sousse Eco Center</td>
                    <td>22/10/2024</td>
                    <td class="text-end">
                ...
                <tr>
                    <td class="text-nowrap">Green Waste Collection</td>
                    <td>10/11/2024</td>
                    <td class="text-end text-nowrap">Pending</td>
                </tr>
                <tr>
                    <td class="text-nowrap">Plastic Collection</td>
                    <td>05/11/2024</td>
                    <td class="text-end text-nowrap">Cancelled</td>
                </tr>
                <tr>
                    <td class="text-nowrap">Cardboard Collection</td>
                    <td>01/12/2024</td>
                    <td class="text-end">
                        <a href="javascript:void(0);" class="btn btn-sm btn-success me-2"><i class="far fa-edit"></i></a>
                        <a href="javascript:void(0);" class="btn btn-sm btn-danger me-2"><i class="far fa-trash-alt"></i></a>
                ...
                <tr>
                    <td class="text-nowrap">Glass Collection</td>
                    <td>20/12/2024</td>
                    <td class="text-end">
                        <a href="javascript:void(0);" class="btn btn-sm btn-success me-2"><i class="far fa-edit"></i></a>
                        <a href="javascript:void(0);" class="btn btn-sm btn-danger me-2"><i class="far fa-trash-alt"></i></a>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="profile.html"><img
                                                                    ...
                                                                    src="{{ asset('Assets/Admin/img/profiles/avatar-14.jpg') }}"
                                                                    alt="User Image">
                                                                Janet Paden
                                                            </a>
                                                        </h2>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="profile.html"><img
                                                                    class="avatar-img rounded-circle me-2"
                                                                    src="{{ asset('Assets/Admin/img/profiles/avatar-01.jpg') }}"
                                                                    alt="User Image">
                                                                George Wells
                                                            </a>
                                                        </h2>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="profile.html"><img
                                                                    class="avatar-img rounded-circle me-2"
                                                                    src="{{ asset('Assets/Admin/img/profiles/avatar-15.jpg') }}"
                                                                    alt="User Image">
                                                                Timothy Smith
                                                            </a>
                                                        </h2>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="profile.html"><img
                                                                    class="avatar-img rounded-circle me-2"
                                                                    src="{{ asset('Assets/Admin/img/profiles/avatar-16.jpg') }}"
                                                                    alt="User Image">
                                                                Lois Alexander
                                                            </a>
                                                        </h2>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="profile.html"><img
                                                                    class="avatar-img rounded-circle me-2"
                                                                    src="{{ asset('Assets/Admin/img/profiles/avatar-04.jpg') }}"
                                                                    alt="User Image">
                                                                Deboarah
                                                            </a>
                                                        </h2>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="profile.html"><img
                                                                    class="avatar-img rounded-circle me-2"
                                                                    src="{{ asset('Assets/Admin/img/profiles/avatar-05.jpg') }}"
                                                                    alt="User Image">
                                                                Rayan Lester
                                                            </a>
                                                        </h2>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="profile.html"><img
                                                                    class="avatar-img rounded-circle me-2"
                                                                    src="{{ asset('Assets/Admin/img/profiles/avatar-10.jpg') }}"
                                                                    alt="User Image">
                                                                Gary Green
                                                            </a>
                                                        </h2>
