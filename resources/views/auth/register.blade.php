...
<div class="main-wrapper login-body">
    <div class="login-wrapper">
        <div class="container">
            <img class="img-fluid logo-dark mb-2" src="{{ asset('images/loader.png') }}" alt="Logo" width="100">

            <div class="loginbox">
                <div class="login-right">
                    <div class="login-right-wrap">
                        <h1>Create an Account</h1> <!-- Titre modifié -->
                        <p class="account-subtitle">Sign up to get started</p> <!-- Sous-titre modifié -->
                        <form method="POST" action="">
                            ...
                            <div class="form-group form-focus">
                                <input type="password" class="form-control floating" id="confirm_password" name="confirm_password" required>
                            ...
                            <button class="thm-btn btn-block btn-lg login-btn" type="submit">Sign Up</button> <!-- Bouton modifié -->
    ...
    <div class="col-lg-12 d-flex justify-content-between align-items-center"> <!-- Flexbox pour aligner les éléments -->
        <div class="dont-have">Already have an account?</div> <!-- Texte indiquant que l'utilisateur a déjà un compte -->
        <a href="/login" class="ml-2" style="color: #dd4b39;">Login here</a> <!-- Lien vers la page de connexion -->
    </div>
</div>
